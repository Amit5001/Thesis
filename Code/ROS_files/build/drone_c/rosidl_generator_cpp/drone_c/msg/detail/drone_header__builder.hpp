...
class Init_DroneHeader_current
{
public:
  explicit Init_DroneHeader_current(::drone_c::msg::DroneHeader & msg)
  : msg_(msg)
  {}
  ::drone_c::msg::DroneHeader current(::drone_c::msg::DroneHeader::_current_type arg)
  {
...
class Init_DroneHeader_voltage
{
public:
  explicit Init_DroneHeader_voltage(::drone_c::msg::DroneHeader & msg)
  : msg_(msg)
  {}
  Init_DroneHeader_current voltage(::drone_c::msg::DroneHeader::_voltage_type arg)
  {
    msg_.voltage = std::move(arg);
    return Init_DroneHeader_current(msg_);
  }
...
class Init_DroneHeader_is_armed
{
public:
  explicit Init_DroneHeader_is_armed(::drone_c::msg::DroneHeader & msg)
  : msg_(msg)
  {}
  Init_DroneHeader_voltage is_armed(::drone_c::msg::DroneHeader::_is_armed_type arg)
  {
    msg_.is_armed = std::move(arg);
    return Init_DroneHeader_voltage(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_DroneHeader_is_armed drone_filter(::drone_c::msg::DroneHeader::_drone_filter_type arg)
  {
    msg_.drone_filter = std::move(arg);
    return Init_DroneHeader_is_armed(msg_);
  }
