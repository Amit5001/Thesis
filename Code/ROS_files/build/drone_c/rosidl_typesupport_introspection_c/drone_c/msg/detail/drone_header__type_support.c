...
static rosidl_typesupport_introspection_c__MessageMember drone_c__msg__DroneHeader__rosidl_typesupport_introspection_c__DroneHeader_message_member_array[6] = {
  {
    "mac_adress",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drone_c__msg__DroneHeader, is_armed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drone_c__msg__DroneHeader, voltage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drone_c__msg__DroneHeader, current),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
