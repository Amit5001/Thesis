...
void Voltmeter::init_voltmeter() {
    _voltmeter_calibration_factor = _drone_data->voltage_current_factors.x;  // Voltage calibration factor
    _current_calibration_factor = _drone_data->voltage_current_factors.y;    // Current calibration factor
    _current_bias = _drone_data->voltage_current_factors.z;                  // Current bias
}