...
float PRateRoll=2; float PRatePitch=PRateRoll; float PRateYaw=1.5;
float IRateRoll=0.02; float IRatePitch=IRateRoll; float IRateYaw=0;
float DRateRoll=0.03; float DRatePitch=DRateRoll; float DRateYaw=0;
float MotorInput1, MotorInput2, MotorInput3, MotorInput4;
float PPterm,IIterm,DDterm;
...
void gyro_signals(void) {
  ...
  AnglePitch=atan(AccY/sqrt(AccX*AccX+AccZ*AccZ))*1/(3.142/180)+5;
...
void loop() {
  ...
  Serial.print("ErrorAnglePitch: "); Serial.println(ErrorAnglePitch);
  Serial.print("PrevErrorAnglePitch: "); Serial.println(PrevErrorAnglePitch);
  Serial.print("PrevItermAnglePitch: "); Serial.println(PrevItermAnglePitch);
  Serial.print("ErrorRatePitch: "); Serial.println(ErrorRatePitch);
  Serial.print("PrevErrorRatePitch: "); Serial.println(PrevErrorRatePitch);
  Serial.print("PrevItermRatePitch: "); Serial.println(PrevItermRatePitch);
